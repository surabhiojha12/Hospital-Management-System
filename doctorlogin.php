...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") 
   {
      ...
      $sql = "SELECT did FROM Doctor WHERE email = '$myusername' and password= '$mypassword'";
...
// Create connection
 ...
 $result = mysqli_query($conn,"SELECT * FROM Doctor where email = '$myusername'");
...
<!--<div class="w3-container">-->
  ...
  <button onclick="document.getElementById('id02').style.display='block'" class="w3-button w3-black">Display</button>
...
<?php
$result_1 = mysqli_query($conn,"SELECT did from Doctor where '$myusername'= email");
  $row1= mysqli_fetch_array($result_1);

$result1= mysqli_query($conn,"SELECT * FROM Patient where did = '{$row1['did']}'");
